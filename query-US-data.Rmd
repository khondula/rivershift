...
This function will create a local shortcut to the shared data directory (only run once)

```{r, eval = FALSE}
file.symlink("/nfs/rivershift-data", "data")
```
...
save_10yr_ts_nwis <- function(state_abbrev, my_codes, my_codes_cat = "chl"){
  ...
  readr::write_csv(glue("data/us-data/nwis-query/nwis_query_{my_codes_cat}-{state_abbrev}.csv"))
}
```
